...
public class Articulo {
    ...
    int stock;
    //constructor
    public Articulo(int c,String d,String tipo,int pc,int pv,int s){
    ...
    public void setTipoProducto(String des){
        this.tipoProducto=des;
    }
    ...
    public String toString(){
        return "Codigo Articulo: "+this.codArticulo+"\n"+
               ...
               "Tipo producto: "+this.tipoProducto+"\n"+
